...
import pi_game.sprites.BombSprite;
...
public class GameController {
    ...
    public static Image bomb_texture = new Image(bomb_rl.toString(), 16, 16, true, false);
    ...
    private SceneSprite startSceneSprite = new SceneSprite(1, 1){
        ...
        public void init() {
            ...
            //Let users can click the image to enter the game
        ...
        @Override
        public void update() {
            this.getGc().clearRect(0, 0, PiGame.SCR_WIDTH, PiGame.SCR_HEIGHT);  //use transparent parent color to clear a portion of the canvas
        }
    };
    ...
    private SceneSprite endSceneSprite = new SceneSprite(){
        ...
        public void init() {
            ...
            this.getScene().setOnMouseClicked(event -> particleController.addParticleSystem(new ParticleSystem(8, event.getX(), event.getY(), 12, 12, 12, ParticleColors.CLICK, new ParticleSystemProperties(3, 3, 3))));  //滑鼠點擊的特效
    ...
    public GameController(int spawn_rate) {
        ...
        bombController = new BombController(this, spawn_rate + 250);
